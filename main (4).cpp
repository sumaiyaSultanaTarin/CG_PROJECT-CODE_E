...
///_________________________________________________Clouds 3___________________________________________________///
   ...
   ///_________ 111 ________///
    GLfloat xc111=-0.120f; GLfloat yc111=0.92f; GLfloat rc111 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    glBegin(GL_TRIANGLE_FAN);
    ...
    GLfloat xc112=-0.140f; GLfloat yc112=0.94f; GLfloat rc112 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc113=-0.135f; GLfloat yc113=0.92f; GLfloat rc113 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc116=-0.160f; GLfloat yc116=0.94f; GLfloat rc116 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc117=-0.155f; GLfloat yc117=0.92; GLfloat rc117 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc118=-0.175f; GLfloat yc118=0.92f; GLfloat rc118 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc221=-0.210f; GLfloat yc221=0.90f; GLfloat rc221 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    glBegin(GL_TRIANGLE_FAN);
    ...
    GLfloat xc222=-0.230f; GLfloat yc222=0.92f; GLfloat rc222 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc223=-0.225f; GLfloat yc223=0.90f; GLfloat rc223 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc226=-0.250f; GLfloat yc226=0.92f; GLfloat rc226 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc227=-0.245f; GLfloat yc227=0.90f; GLfloat rc227 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc228=-0.265f; GLfloat yc228=0.90f; GLfloat rc228 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc331=-0.720f; GLfloat yc331=0.92f; GLfloat rc331 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    glBegin(GL_TRIANGLE_FAN);
    ...
    GLfloat xc332=-0.740f; GLfloat yc332=0.94f; GLfloat rc332 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc333=-0.735f; GLfloat yc333=0.92f; GLfloat rc333 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc336=-0.760f; GLfloat yc336=0.94f; GLfloat rc336 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    ///_________ 37 ________///
    GLfloat xc337=-0.755f; GLfloat yc337=0.92f; GLfloat rc337 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc338=-0.775f; GLfloat yc338=0.92f; GLfloat rc338 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc441=-0.810f; GLfloat yc441=0.90f; GLfloat rc441 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    glBegin(GL_TRIANGLE_FAN);
    ...
    GLfloat xc442=-0.830f; GLfloat yc442=0.92f; GLfloat rc442 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    GLfloat xc443=-0.825f; GLfloat yc443=0.90f; GLfloat rc443 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    ///_________ 46 ________///
    GLfloat xc446=-0.850f; GLfloat yc446=0.92f; GLfloat rc446 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    ///_________ 47 ________///
    GLfloat xc447=-0.845f; GLfloat yc447=0.90f; GLfloat rc447 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
    ...
    ///_________ 48 ________///
    GLfloat xc448=-0.865f; GLfloat yc448=0.90f; GLfloat rc448 =.015f;
    glColor3f(1.0f, 1.0f, 1.0f);
...
///______________________________________________Annex Tower___________________________________________________///
    ...
    GLfloat xl1=0.19f; GLfloat yl1=0.5f; GLfloat rl1 =.013f;
    glBegin(GL_TRIANGLE_FAN);
    ...
    glColor3f(1.0, 1.0, 1.0);
    GLfloat xr11=0.26f; GLfloat yr11=0.56f; GLfloat rr11 =.013f;
    glBegin(GL_TRIANGLE_FAN);
    ...
    glColor3f(1.0, 1.0, 1.0);
    GLfloat xr21=0.26f; GLfloat yr21=0.44f; GLfloat rr21 =.013f;
    glBegin(GL_TRIANGLE_FAN);
...
///_____________________________________________ROCKET(START)___________________________________________________///
    ...
    glVertex2f(0.44f,0.23f);
    glEnd();
    ///_________ 1 stand border________///
    glLineWidth(1.5);
    glBegin(GL_LINES);
    glColor3f(0.0,0.0,0.0);
    glVertex2f(0.37f,0.23f);
